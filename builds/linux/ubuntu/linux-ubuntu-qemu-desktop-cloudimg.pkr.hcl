...
variable "vm_guest_os_family" {
  type        = string
  default     = "linux"
  description = "OS family for naming."
}
variable "vm_guest_os_name" {
  type        = string
  default     = "ubuntu"
  description = "OS name for naming."
}
variable "vm_guest_os_version" {
  type        = string
  default     = "22.04-lts"
  description = "OS version for naming."
}
variable "vm_guest_os_type" {
  type        = string
  default     = "ubuntu64Guest"
  description = "Informational guest type label (manifest)."
}
variable "vm_firmware" {
  type        = string
  default     = "efi-secure"
  description = "Manifest label only."
}
...
# Optional explicit layouts (kept same as server template)
...
locals {
  ...
  bucket_description = "${var.vm_guest_os_family} ${var.vm_guest_os_name} ${var.vm_guest_os_version} Desktop"
}
...
build {
  ...
  provisioner "ansible" {
    ...
    playbook_file          = "${abspath(path.root)}/../../../ansible/linux-desktop-playbook.yml"
  ...
  # Convert exports + optional OVF/OVA
