...
variable "iso_url" {
  ...
  description = "Official Ubuntu Resolute Raccoon cloud image URL. Override with file:///... or another mirror if desired."
}

variable "iso_checksum" {
  type        = string
  default     = "sha256:CHANGE_ME"
  description = "Checksum for the Resolute cloud image. Refresh from Canonical's current SHA256SUMS before building."
}
